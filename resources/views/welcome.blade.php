    ...
    <body>
       ...
       <!--  <div>
        ...
        <div id="acerca-de" class="w-full bg-neutral-800" style="height: auto;">
            <div class="flex flex-col md:flex-row items-center justify-start">
                <div class="w-full md:w-1/2">
                    <h2 class="text-white text-5xl md:text-6xl font-bold mb-10 pl-4 md:pl-20 animate-fade-in">¿Quiénes somos?</h2>
                    <p class="text-white text-2xl md:text-3xl mb-5 pl-4 md:pl-20 pr-4 md:pr-20 animate-fade-in">Nos dedicamos a ofrecer tranquilidad y protección financiera a nuestros clientes.</p>
                    <p class="text-white text-2xl md:text-3xl mb-5 pl-4 md:pl-20 pr-4 md:pr-20 animate-fade-in">Nuestra misión es proporcionar soluciones de servicios de calidad que les permitan enfrentar los desafíos de la vida con confianza y seguridad.</p>
                </div>
                <div class="w-full md:w-1/2 ">
        ...
        <div id="servicios" class="w-full bg-cover bg-center bg-no-repeat bg-fixed" style="background-image: url('{{ asset('/img/people.png') }}'); height: auto;">
            <h2 class="text-white text-5xl md:text-6xl pl-4 md:pl-20 pt-6 md:pt-20 font-bold">Nuestros servicios</h2>
            <div class="grid grid-rows-1 grid-cols-1 md:grid-cols-3 gap-4 mt-20" >
                <div class="row-span-1 p-4 text-white">
                    <p class="text-2xl md:text-3xl pl-4 md:pl-20 pt-6">Gastos médicos mayores.</p>
                    <p class="text-2xl md:text-3xl pl-4 md:pl-20 pt-6">Seguro de vida</p>
                    <p class="text-2xl md:text-3xl pl-4 md:pl-20 pt-6">Seguro de hogar</p>
                    <p class="text-2xl md:text-3xl pl-4 md:pl-20 pt-6">Seguro de auto</p>
                </div>
                <div class="row-span-1 p-4 text-white">
                    <p class="text-2xl md:text-3xl pl-4 md:pl-20 pt-6">Retiro</p>
                    <p class="text-2xl md:text-3xl pl-4 md:pl-20 pt-6">Inversión</p>
                    <p class="text-2xl md:text-3xl pl-4 md:pl-20 pt-6">Rentas privadas</p>
                    <p class="text-2xl md:text-3xl pl-4 md:pl-20 pt-6">Póliza de comercio</p>
                </div>
                <div class="row-span-1 p-4 text-white">
                    ...
                    <p class="text-lg md:text-xl pt-8  pb-60">En asociación con Allianz, líder mundial en administración de activos, te ofrecemos una oportunidad única para hacer crecer tu patrimonio y asegurar un mañana más próspero. No importa cuáles sean tus objetivos financieros, estamos aquí para ayudarte a alcanzarlos.</p>
                </div>
            </div>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10 pl-4 md:pl-20 pr-4 md:pr-20">
                    ...
                    <div class="w-full bg-neutral-700 p-4 rounded-lg shadow-lg px-10 py-10">
                        <div class="flex">
                            ...
                            <div class="w-1/2 rounded-lg text-white pl-8 text-xl">
